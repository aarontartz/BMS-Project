...
class BatteryCanvas(FigureCanvas):
    def __init__(self):
        ...
        self.axes.set_ylabel("State of Charge (%)", fontsize=16)
        self.axes.set_title("Battery State of Charge", fontsize=18, fontweight='bold')
        self.axes.grid(True)
...
class AnomalyCanvas(FigureCanvas):
    def __init__(self):
        ...
        self.axes.set_xlabel("Time (s)", fontsize=16)
        self.axes.set_ylabel("Anomaly Score", fontsize=16)
        self.axes.set_title("Battery Anomaly Detection", fontsize=18, fontweight='bold')
        self.axes.grid(True)
...
class SOHCanvas(FigureCanvas):
    def __init__(self):
        ...
        self.axes.set_ylim(0, 100)
        self.axes.set_xlabel("Time (s)", fontsize=16)
        self.axes.set_ylabel("State of Health (%)", fontsize=16)
        self.axes.set_title("Battery Health Estimation", fontsize=18, fontweight='bold')
        self.axes.grid(True)
...
class BatteryManagementAI:
    ...
    def update_models(self):
        ...
        try:
            ...
            self.signals.log_event.emit(f"Error updating models: {str(e)}")
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        form = QFormLayout()
        big = QFont(); big.setPointSize(18)
        big_bold = QFont(); big_bold.setPointSize(18); big_bold.setBold(True)
        ...
        self.timer.start(int(self.sample_dt * 1000))  # 500 ms
