...
class BatteryCanvas(FigureCanvas):
    def __init__(self,parent=None,width=6,height=3,dpi=100):
        ...
        self.axes.grid(True)
        self.soc_text=self.axes.text(0.02,0.95,'SOC: 0.0%',transform=self.axes.transAxes,fontsize=12)
        fig.tight_layout()
...
class MainWindow(QMainWindow):
    ...
    def update_readings(self):
        ...
        #safety
        red_trip=(temp_c>self.RED_TEMP or current>self.RED_CURRENT or batt_v>self.RED_VOLTAGE)
